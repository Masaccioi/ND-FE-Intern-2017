  ...
  module: {
    rules: [
      ...
      },
      {
        ...
        loader: 'nd-file-loader',
        options: {
          name: './style/[hash:7]-[name].[ext]', // 保持 @ 字符后的数字
          usePath: true // 使用路径的 hash 值
        }
      },
      {
        test: /\.(png|jpg|gif|svg|woff2?|eot|ttf)(\?.*)?$/,
        exclude: /@[1-3]x/, // skip encoding @1x/@2x/@3x images with base64
        loader: 'nd-file-loader', // 'url-loader',
        options: {
          limit: 10000, // file-loader 情况下，该属性失效
          name: './style/[name][hash:7].[ext]', // : '[name].[ext]?[hash:7]',
          usePath: true // 使用路径的 hash 值
        }
      }
    ]
